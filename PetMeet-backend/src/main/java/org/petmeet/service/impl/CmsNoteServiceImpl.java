...
public class CmsNoteServiceImpl extends ServiceImpl<CmsNoteMapper, CmsNote> implements CmsNoteService {
     ...
     */
    @Override
    public Page<NoteListVO> pageList(Integer pageNum, Integer pageSize, String keyword, Long productId, String category, String tag, Boolean recommended) {
        // 先查缓存，命中就直接返回
        String cacheKey = noteRedisSupport.buildNoteListCacheKey(pageNum, pageSize, keyword, productId, category, tag, recommended);
